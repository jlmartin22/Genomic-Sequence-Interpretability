...
def parse_args():
    ...
    parser.add_argument("-mn", "--model_name",
                        default='best_model.pt', type=str,
...
#     motif_len = args.window_sz
    ...
    model_name = os.path.join(proj_dir, 'Model', mod_name)
...
#         print(pos_pred)
        ...
        write_file = os.path.join(proj_dir,'Data', f'generated_data_{datetime.datetime.now().strftime("%Y%m%d")}.pickle')
